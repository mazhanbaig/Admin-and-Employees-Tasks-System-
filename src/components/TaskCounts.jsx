...
const TaskCounts = () => {
    ...
    return (
        <div className="p-2 sm:p-6 flex justify-between gap-4 overflow-x-auto no-scrollbar">
            {/* Total Tasks */}
            <div className="min-w-[200px] w-[200px] sm:w-[250px] bg-blue-100 border-l-4 border-blue-500 p-6 rounded-xl shadow-md flex flex-col items-center flex-shrink-0">
                <h3 className="text-lg font-semibold text-blue-700">Total</h3>
                <p className="text-3xl font-bold text-blue-900">{totalCount}</p>
            </div>

            {/* Completed */}
            <div className="min-w-[200px] w-[200px] sm:w-[250px] bg-green-100 border-l-4 border-green-500 p-6 rounded-xl shadow-md flex flex-col items-center flex-shrink-0">
            ...
            {/* Pending */}
            <div className="min-w-[200px] w-[200px] sm:w-[250px] bg-yellow-100 border-l-4 border-yellow-500 p-6 rounded-xl shadow-md flex flex-col items-center flex-shrink-0">
                <h3 className="text-lg font-semibold text-yellow-700">Pending</h3>
                <p className="text-3xl font-bold text-yellow-900">{pendingCount}</p>
            </div>

            {/* Failed */}
            <div className="min-w-[200px] w-[200px] sm:w-[250px] bg-red-100 border-l-4 border-red-500 p-6 rounded-xl shadow-md flex flex-col items-center flex-shrink-0">
            ...
            <div className="min-w-[200px] w-[200px] sm:w-[250px] bg-purple-100 border-l-4 border-purple-500 p-6 rounded-xl shadow-md flex flex-col items-center flex-shrink-0">
